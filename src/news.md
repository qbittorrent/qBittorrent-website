...
This is a major version release and a huge list of changes have been accumulated. I want to give a big thank you to all the people involved, both developers and troubleshooters.<br>
The provided macOS builds are self-signed which may cause scary warnings from macOS. macOS support and compatibility isn't our main priority.
...
<table>
  ...
  <tbody>
    <tr>
      <td>libtorrent</td>
      <td>1.2.20+gitc5ff6c3186 / 2.0.12+gitfa2f95785e</td>
    </tr>
    <tr>
      <td>Qt</td>
      <td>6.10.3</td>
...
- [Full changes](https://github.com/qbittorrent/qBittorrent/compare/release-5.1.4...release-5.2.0)
...
macOS builds will be available on a later date.<br>
AppImages should work natively under Wayland now.<br>
A changelog for v5.2.0beta1 is not available.
...
<table>
  ...
  <tbody>
    <tr>
      <td>libtorrent</td>
      <td>1.2.20+git3ae563b043 / 2.0.11+gitf591196481</td>
    </tr>
    <tr>
      <td>Qt</td>
      <td>6.10.1</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td>libtorrent</td>
      <td>1.2.20+git68ec0785cd / 2.0.11+git80f8d0796c</td>
    </tr>
    <tr>
      <td>Qt</td>
      <td>6.9.0</td>
...
- [Full changes](https://github.com/qbittorrent/qBittorrent/compare/release-5.0.5...release-5.1.0)
