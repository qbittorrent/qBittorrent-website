...
<fieldset style="background-color: #efefef">
  <div class="myface" style="width: 96px; height: 96px; float: left;">
    <img src="img/team/unknown.png" alt="sledgehammer999"/>
  </div>
  <div class="info" style="height: 96px; float:left;">
    <ul>
...
<fieldset style="background-color: #efefef">
  <div class="myface" style="width: 96px; height: 116px; float: left;">
    <img src="img/team/chris.png" alt="Christophe Dumez ('chris')"/>
  </div>
  <div class="info" style="height: 118px; float:left;">
    <ul>
